...
export const AboutData = {
  ...
  paragraphOne: "Ich wurde 1956 in Bremen geboren, wuchs im Emsland und in Friesland auf, studierte und promovierte an der Universität in Clausthal-Zellerfeld.",
  paragraphTwo: "Schon während meines Mineralogie- und Geologiestudiums zog es mich hinaus in die weite Welt. Fasziniert von fremdartigen Landschaften und Menschen hielt ich mich monatelang in Namibia, Peru und Brasilien auf. Je unwirtlicher die Landschaft, je fremder die Kulturen, desto größer war der Reiz des Entdeckens. So durchwanderte ich als Geologe und Naturliebhaber die Wüsten, Hochgebirge oder Dschungelgebiete der Erde.",
  paragraphThree: "Aber auch die großen Metropolen der Welt haben es mir angetan. Das quirlige Rio de Janeiro wurde so zu meiner zweiten Heimat. Fünfzehn  Jahre lang habe ich als Geologe, Bergwerksdirektor und Reiseleiter in Südamerika, sieben Jahre im südlichen Afrika  gelebt und gearbeitet. Für vier Jahre war ich beruflich in Asien tätig. Heute wohne ich in meiner neuen Wahlheimat in Elmshorn und betreue seit 2007 als Lektor und Reiseleiter Studienreisen, Kreuzfahrten und Kreuzflüge.",
  paragraphFour: "Meine Hobbys sind neben dem Reisen und Wandern das Fotografieren,  Kochen, sowie gutes Essen und südamerikanische Weine. So versuche ich meine Gäste mit außergewöhnlichen Vorträgen, wunderschönen Bildern und kleinen exotischen Restaurants abseits der normalen Touristenpfade zu verzaubern.",
  buttonLabel: "Kontakt",
  image: ImageAbout,
  reverse: false,
  delay: 100
